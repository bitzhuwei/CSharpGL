...
namespace CSharpGL.SoftGL {
    ...
    /// </summary>
    public unsafe partial class SoftGLRenderContext : GLRenderContext, IDisposable {
        ...
        /// <returns></returns>
        private SoftGLRenderContext(IntPtr handle, int width, int height, /*ContextGenerationParams genParams, */IntPtr hDC, IntPtr hRC, GL glFunctions)
            : base(handle, width, height, /*genParams,*/ hDC, hRC, glFunctions) {
        }
        ...
        public override bool Blit(IntPtr hDC) {
            ...
            ////	Blit the DC (containing the DIB section) to the target DC.
            //Win32.BitBlt(hDC, 0, 0, this.width, this.height, this.dibSection.memoryDeviceContext, 0, 0, 0x00CC0020/*SRCCOPY*/);
        }
        ...
        public override void MakeCurrent() {
            ...
            if (this.hRC != IntPtr.Zero) {
                SoftGLImpl.SoftGL.MakeCurrent(this.hDC, this.hRC);
