...
";
        ...
        private TextBillboardRenderer(ITextureSource textureSource, int width, int height, IBufferable model, RenderUnitBuilder renderUnitBuilder)
    ...
    class TextBillboard : IBufferable
    {
