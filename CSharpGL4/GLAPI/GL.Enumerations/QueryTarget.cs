namespace CSharpGL
{
    ...
    public enum ConditionalRenderMode : uint
    {
        ...
        ///
        /// </summary>
        QueryWait = GL.GL_QUERY_WAIT,

        /// <summary>
        ///
        /// </summary>
        QueryNoWait = GL.GL_QUERY_NO_WAIT,

        /// <summary>
        ///
        /// </summary>
        QueryByRegionWait = GL.GL_QUERY_BY_REGION_WAIT,

        /// <summary>
        ///
        /// </summary>
        QueryByRegionNoWait = GL.GL_QUERY_BY_REGION_NO_WAIT,
    }
}