...
namespace CSharpGL {
    ...
    /// </summary>
    public unsafe class TexBufferStorage : TexStorageBase, IDisposable {
        ...
        //    glTexBuffer = gl.glGetDelegateFor("glTexBuffer", GLDelegates.typeof_void_uint_uint_uint) as GLDelegates.void_uint_uint_uint;
        //}
        ...
        public override void Apply() {
            ...
            gl.glTexBuffer(GL.GL_TEXTURE_BUFFER, internalFormat, buffer.bufferId);
        }
        ...
        private void Dispose(bool disposing) {
            if (this.disposedValue == false) {
                ...
                if (this.autoDispose) {
                    if (this.buffer is IDisposable disp) { disp.Dispose(); }
                }
            } // end if
