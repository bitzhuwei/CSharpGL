...
namespace CSharpGL {
    ...
    public unsafe class MultiDrawElementsCmd : IDrawCommand, IDisposable {
        /// <summary>
        ...
        public MultiDrawElementsCmd(DrawMode mode, int[] count, uint[] allIndices)
            : this(mode, count, (Array)allIndices) { }
        ...
        /// <param name="allIndices"></param>
        /// <param name="baseVertex"></param>
        public MultiDrawElementsCmd(DrawMode mode, int[] count, ushort[] allIndices)
            : this(mode, count, (Array)allIndices) { }
        ...
        /// <param name="allIndices"></param>
        /// <param name="baseVertex"></param>
        public MultiDrawElementsCmd(DrawMode mode, int[] count, byte[] allIndices)
            : this(mode, count, (Array)allIndices) { }

        private MultiDrawElementsCmd(DrawMode mode, int[] count, Array allIndices) {
        ...
        public void Draw() {
            ...
            GCHandle pinIndices = GCHandle.Alloc(indices, GCHandleType.Pinned);
            IntPtr header = pinIndices.AddrOfPinnedObject();
            gl.glMultiDrawElements((GLenum)this.Mode, this.count, (GLenum)this.type, header, this.count.Length);
            pinIndices.Free();
            pinAll.Free();
        }
        ...
        //{
        //    glMultiDrawElements = gl.glGetDelegateFor("glMultiDrawElements", GLDelegates.typeof_void_uint_intN_uint_IntPtr_int) as GLDelegates.void_uint_intN_uint_IntPtr_int;
        //}
