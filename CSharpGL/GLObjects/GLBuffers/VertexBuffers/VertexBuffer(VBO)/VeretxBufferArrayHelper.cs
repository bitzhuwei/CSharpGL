...
namespace CSharpGL {
    ...
    /// 
    /// </summary>
    public static unsafe class __VeretxBufferArrayHelper {
        /// <summary>
        ...
        public static IEnumerable<IndexesInBuffer> GetWorkItems(this GLBuffer[] buffers, IEnumerable<uint> indexes) {
            ...
            for (int i = 1; i < counts.Length; i++) {
                ...
                counts[i] = counts[i - 1] + (uint)buffers[i - 1].count;
            }
    ...
    /// 
    /// </summary>
    public unsafe class IndexesInBuffer {
        /// <summary>
        /// which buffer.
        /// </summary>
    ...
    unsafe class IndexInBuffer {
        ...
        /// </summary>
        public readonly uint indexInBuffer;
