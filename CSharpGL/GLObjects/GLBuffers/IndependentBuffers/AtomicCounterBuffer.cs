...
namespace CSharpGL {
    ...
    /// </summary>
    public unsafe partial class AtomicCounterBuffer : GLBuffer {
        /// <summary>
        ...
        internal AtomicCounterBuffer(
            ...
            : base(Target.AtomicCounterBuffer, bufferId, length, byteLength, usage) {
        }
        ...
        /// <returns></returns>
        public static AtomicCounterBuffer Create(Type elementType, int count, GLBuffer.Usage usage) {
            ...
            var bufferId = CallGL((GLenum)IndependentBufferTarget.AtomicCounterBuffer, byteLength, IntPtr.Zero, usage);

            var buffer = new AtomicCounterBuffer(bufferId, count, byteLength, usage);
            return buffer;
        }
    }
}