...
namespace CSharpGL
{
    public partial class Framebuffer
    {
        ...
        public void Attach(Texture texture, int mipmapLevel = 0)
        {
            ...
            glFramebufferTexture(GL.GL_FRAMEBUFFER, attachment_id[nextColorAttachmentIndex++], texture.Id, mipmapLevel);
        }
        ...
        public void Attach(Texture texture, bool depthAttachment, int mipmapLevel = 0)
        {
            ...
            else
            {
                ...
                glFramebufferTexture2D(GL.GL_FRAMEBUFFER, attachment_id[nextColorAttachmentIndex++], (uint)texture.Target, texture.Id, mipmapLevel);
            }
        }
        ...
        public Texture Attach(TextureAttachment type)
        {
            ...
            switch (type)
            {
                case TextureAttachment.ColorAttachment:
                    ...
                    result.Initialize();
                    glFramebufferTexture(GL.GL_FRAMEBUFFER, attachment_id[nextColorAttachmentIndex++], result.Id, mipmapLevel);
                    break;
