    ...
    public partial class HighlightRenderer
    {
        ...
        protected override void DoInitialize()
        {
            ...
            OneIndexBuffer indexBuffer;
            {
                ...
                indexBuffer = Buffer.Create(IndexElementType.UInt, positionBuffer.ByteLength / (positionBuffer.Config.GetDataSize() * positionBuffer.Config.GetDataTypeByteLength()), mode, BufferUsage.StaticDraw);
