...
{
    class NewFakeSampler2D : NewSampler2DBase
    {
        public NewFakeSampler2D(TextureWrapping wrapping, TextureFiltering textureFiltering, MipmapFiltering mipmapFiltering)
