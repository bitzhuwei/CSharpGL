...
namespace CSharpGL
{
    ...
    class NewFakeSampler : NewSamplerBase
    {
        ...
        /// </summary>
        public TextureWrapping Wrapping { get { return this.wrapping; } set { this.wrapping = value; } }
        ...
        /// </summary>
        public TextureFilter TextureFilter { get { return this.textureFilter; } set { this.textureFilter = value; } }
