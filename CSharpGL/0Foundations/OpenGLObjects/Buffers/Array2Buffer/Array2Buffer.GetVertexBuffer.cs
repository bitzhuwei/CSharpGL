...
namespace CSharpGL
{
    public static partial class Array2Buffer
    {
        ...
        /// <returns></returns>
        public static VertexBuffer GetVertexBufferObject<T>(this T[] array, string varNameInVertexShader, VBOConfig config, BufferUsage usage, uint instancedDivisor = 0, int patchVertexes = 0) where T : struct
        {
