namespace CSharpGL
{
    ...
    public class PixelPackBuffer<T> : IndependentBuffer<T> where T : struct
    {
        /// <summary>
        ///
        /// </summary>
        ...
        public PixelPackBuffer(BufferUsage usage, bool noDataCopyed = false)
        ...
        protected override IndependentBufferPtr Upload2GraphicsCard()
        {
            ...
            var bufferPtr = new PixelPackBufferPtr(buffers[0], this.Length, this.ByteLength);
