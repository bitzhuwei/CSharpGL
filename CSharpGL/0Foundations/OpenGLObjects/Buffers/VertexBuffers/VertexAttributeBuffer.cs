namespace CSharpGL
{
    ...
    /// <para>Note: If <typeparamref name="T"/> matches one of this.Config's value, then (this.ByteLength / (this.DataSize * this.DataTypeByteLength)) equals (this.Length).</para>
    /// </summary>
