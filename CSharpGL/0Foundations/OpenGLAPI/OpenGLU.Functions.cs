namespace CSharpGL
{
    public static partial class OpenGL
    {
        ...
        ////[Obsolete(obsoleteGluDll, error)]
        //[DllImport(Win32.Glu32, SetLastError = true)]
        //public static extern void gluQuadricNormals(IntPtr quadricObject, uint normals);
        ...
        ////[Obsolete(obsoleteGluDll, error)]
        //[DllImport(Win32.Glu32, SetLastError = true)]
        //public static extern void gluQuadricTexture(IntPtr quadricObject, int textureCoords);
        ...
        ////[Obsolete(obsoleteGluDll, error)]
        //[DllImport(Win32.Glu32, SetLastError = true)]
        //public static extern void gluQuadricOrientation(IntPtr quadricObject, int orientation);
        ...
        ////[Obsolete(obsoleteGluDll, error)]
        //[DllImport(Win32.Glu32, SetLastError = true)]
        //public static extern void gluQuadricDrawStyle(IntPtr quadricObject, uint drawStyle);
        ...
        ////[Obsolete(obsoleteGluDll, error)]
        //[DllImport(Win32.Glu32, SetLastError = true)]
        //public static extern void gluCylinder(IntPtr quadricObject, double baseRadius, double topRadius, double height, int slices, int stacks);
        ...
        ////[Obsolete(obsoleteGluDll, error)]
        //[DllImport(Win32.Glu32, SetLastError = true)]
        //public static extern void gluDeleteNurbsRenderer(IntPtr nurbsObject);
        ...
        ////[Obsolete(obsoleteGluDll, error)]
        //[DllImport(Win32.Glu32, SetLastError = true)]
        //public static extern void gluBeginSurface(IntPtr nurbsObject);
        ...
        ////[Obsolete(obsoleteGluDll, error)]
        //[DllImport(Win32.Glu32, SetLastError = true)]
        //public static extern void gluBeginCurve(IntPtr nurbsObject);
        ...
        ////[Obsolete(obsoleteGluDll, error)]
        //[DllImport(Win32.Glu32, SetLastError = true)]
        //public static extern void gluEndCurve(IntPtr nurbsObject);
        ...
        ////[Obsolete(obsoleteGluDll, error)]
        //[DllImport(Win32.Glu32, SetLastError = true)]
        //public static extern void gluEndSurface(IntPtr nurbsObject);

        ///// <summary>
        ///// Delimit a NURBS trimming loop definition.
        ///// </summary>
        ///// <param name="nurbsObject">Specifies the NURBS object (created with gluNewNurbsRenderer).</param>
        ////[Obsolete(obsoleteGluDll, error)]
        //[DllImport(Win32.Glu32, SetLastError = true)]
        //public static extern void gluBeginTrim(IntPtr nurbsObject);
        ...
        ////[Obsolete(obsoleteGluDll, error)]
        //[DllImport(Win32.Glu32, SetLastError = true)]
        //public static extern void gluEndTrim(IntPtr nurbsObject);
        ...
        ////[Obsolete(obsoleteGluDll, error)]
        //[DllImport(Win32.Glu32, SetLastError = true)]
        //public static extern void gluPwlCurve(IntPtr nurbsObject, int count, float array, int stride, uint type);
        ...
        ////[Obsolete(obsoleteGluDll, error)]
        //[DllImport(Win32.Glu32, SetLastError = true)]
        //public static extern void gluNurbsCurve(IntPtr nurbsObject, int knotsCount, float[] knots, int stride, float[] controlPointsArray, int order, uint type);
        ...
        ////[Obsolete(obsoleteGluDll, error)]
        //[DllImport(Win32.Glu32, SetLastError = true)]
        //public static extern void gluNurbsSurface(IntPtr nurbsObject, int sknotsCount, float[] sknots, int tknotsCount, float[] tknots, int sStride, int tStride, float[] controlPointsArray, int sOrder, int tOrder, uint type);
        ...
        ////[Obsolete(obsoleteGluDll, error)]
        //[DllImport(Win32.Glu32, SetLastError = true)]
        //public static extern void gluLoadSamplingMatrices(IntPtr nurbsObject, float[] modelMatrix, float[] projMatrix, int[] viewport);
        ...
        ////[Obsolete(obsoleteGluDll, error)]
        //[DllImport(Win32.Glu32, SetLastError = true)]
        //public static extern void gluNurbsProperty(IntPtr nurbsObject, int property, float value);
