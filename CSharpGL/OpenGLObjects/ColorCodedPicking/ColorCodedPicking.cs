...
namespace CSharpGL
{
    public static class ColorCodedPicking
    {
            ...
            params IColorCodedPicking[] pickableElements)
        {
            ...
            List<Tuple<Point, PickedGeometry>> list = Pick(e, geometryType,
             ...
             params IColorCodedPicking[] pickableElements)
        {
            ...
            return Pick(e, geometryType, rect, width, height,  pickableElements);
        }
            ...
            params IColorCodedPicking[] pickableElements)
        {
            ...
            Render4Picking(e,  pickableElements);
            ...
            for (int row = 0; row < rect.Width; row++)
            {
                for (int col = 0; col < rect.Height; col++)
                {
                    ...
                    PickedGeometry pickedGeometry = ReadPixel(e, geometryType,
        ...
        private static void Render4Picking(RenderEventArgs e, IColorCodedPicking[] pickableElements)
        {
            // 暂存clear color
            ...
            IColorCodedPicking[] pickableElements)
        {
                ...
                && codedColor[2] == byte.MaxValue && codedColor[3] == byte.MaxValue))
            {
                ...
                {
                    pickedGeometry = item.Pick(e, geometryType, stageVertexId,
