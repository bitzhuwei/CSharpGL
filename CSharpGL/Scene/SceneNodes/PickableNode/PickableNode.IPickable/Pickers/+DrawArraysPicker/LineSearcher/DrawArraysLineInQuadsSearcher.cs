...
namespace CSharpGL {
    internal class DrawArraysLineInQuadSearcher : DrawArraysLineSearcher {
        ...
        /// <returns></returns>
        internal unsafe override uint[] Search(PickingEventArgs arg,
            ...
            if (id + 3 == stageVertexId) { return new uint[] { id + 3, id, }; }
            else if (id + 2 == stageVertexId) { return new uint[] { id - 1, id, }; }
            else if (id + 1 == stageVertexId) { return new uint[] { id - 1, id, }; }
