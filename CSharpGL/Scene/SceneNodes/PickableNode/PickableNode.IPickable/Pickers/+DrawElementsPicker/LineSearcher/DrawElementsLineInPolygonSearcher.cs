...
namespace CSharpGL {
    internal class DrawElementsLineInPolygonSearcher : DrawElementsLineSearcher {
        ...
        internal override uint[] Search(PickingEventArgs arg,
            ...
            IndexBuffer buffer = vertexIds.GenIndexBuffer(IndexBuffer.ElementType.UInt, GLBuffer.Usage.StaticDraw);
            ...
            if (id == baseId + vertexIds[0]) { return new uint[] { baseId + vertexIds[vertexIds.Length - 1], id, }; }
            else {
                uint[]? result = null;
