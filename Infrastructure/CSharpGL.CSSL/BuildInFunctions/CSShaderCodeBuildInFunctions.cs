namespace CSharpGL.CSSL
{
    ...
    public abstract partial class CSShaderCode
    {
        ...
        public static vec2 vec2(double v0)
        {
            return null;
        }

        public static vec2 vec2(double v1, double v2)
        {
            return null;
        }

        public static vec2 vec2(vec2 v1)
        {
            return null;
        }

        public static vec2 vec2(vec3 v1)
        {
            return null;
        }

        public static vec2 vec2(vec4 v1)
        {
            return null;
        }

        public static vec3 vec3(double v0)
        {
            return null;
        }

        public static vec3 vec3(double v1, double v2, double v3)
        {
            return null;
        }

        public static vec3 vec3(vec2 v1, double v2)
        {
            return null;
        }

        public static vec3 vec3(double v1, vec2 v2)
        {
            return null;
        }
        ...
        public static vec3 vec3(vec4 v1)
        {
            return null;
        }

        public static vec4 vec4(double v0)
        {
            return null;
        }

        public static vec4 vec4(double v1, double v2, double v3, double v4)
        {
            return null;
        }

        public static vec4 vec4(vec2 v2, double v3, double v4)
        {
            return null;
        }

        public static vec4 vec4(vec2 v2, vec2 v4)
        {
            return null;
        }

        public static vec4 vec4(double v1, vec2 v3, double v4)
        {
            return null;
        }

        public static vec4 vec4(double v1, double v2, vec2 v4)
        {
            return null;
        }
        ...
        public static vec4 vec4(vec4 v1)
        {
            return null;
        }
        ...
        public static mat4 mat4(double value)
        {
            return null;
        }
