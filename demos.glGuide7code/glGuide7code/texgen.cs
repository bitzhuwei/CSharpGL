...
namespace demos.glGuide7code {
  ...
  */
    public unsafe class texgen : _glGuide7code {

        public texgen(Form mainForm, int width, int height, GL gl)
        ...
        public override void init(CSharpGL.GL gl) {
            ...
            if (texName[0] == 0) {
                var texture = stackalloc GLuint[2];
                gl.glGenTextures(2, texture); texName[0] = texture[0]; texName[1] = texture[1];
