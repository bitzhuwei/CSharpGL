...
namespace c01d01_PropertyGrid
{
    partial class CubeNode : ModernNode, IRenderable
    {
        ...
        private vec4 cubeColor = new vec4(1, 0, 0, 1);
        [System.ComponentModel.Category("CubeNode")]
        public System.Drawing.Color CubeColor
        {
            get { return this.cubeColor.ToColor(); }
            set
            {
                vec3 v = value.ToVec3();
                this.cubeColor = new vec4(v, 1);
                ...
                //set value for 'uniform mat4 color'; in shader.
                program.SetUniform("color", this.cubeColor);
            }
        }
