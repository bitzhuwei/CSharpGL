    ...
    class ParticlesModel : IBufferSource
    {
        ...
        public IEnumerable<VertexBuffer> GetVertexAttribute(string bufferName)
        {
            if (strPosition == bufferName)
            {
                ...
                {
                    this.positionBuffer = this.positions.GenVertexBuffer(VBOConfig.Vec4, BufferUsage.DynamicCopy);
                }
            ...
            else if (strVelocity == bufferName)
            {
                ...
                {
                    this.velocityBuffer = this.velocities.GenVertexBuffer(VBOConfig.Vec4, BufferUsage.DynamicCopy);
                }
