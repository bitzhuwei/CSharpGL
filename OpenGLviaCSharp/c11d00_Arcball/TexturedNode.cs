...
{
    partial class TexturedNode : ModernNode, IBlinnPhong
    {
        public static TexturedNode Create(IBufferSource model, string position, string normal, string uv, Texture texture, vec3 size)
        {
            ...
            var node = new TexturedNode(model, ambientBuilder, blinnPhongBuilder);
        ...
        private TexturedNode(IBufferSource model, params RenderMethodBuilder[] builders)
            : base(model, builders)
        {
