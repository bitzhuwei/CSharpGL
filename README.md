...
[CSharpGL](https://github.com/bitzhuwei/CSharpGL) wraps OpenGL API(buffer, shader, texture, matrix, toggle etc) and demostrates how to express high-level functions(scene, text, picking, UI etc) with CSharpGL library.  
