...
namespace CSharpGL {
    ...
    /// </summary>
    public unsafe class PropellerRenderer : ModernNode, IRenderable {
...
";
        ...
        private PropellerRenderer(Propeller model, params RenderMethodBuilder[] builders)
            : base(model, builders) {
    ...
    class Propeller : IBufferSource {
        ...
        public IEnumerable<IDrawCommand> GetDrawCommand() {
            if (this.drawCmd == null) {
                IndexBuffer buffer = indexes.GenIndexBuffer(IndexBuffer.ElementType.UByte, GLBuffer.Usage.StaticDraw);
