...
namespace CSharpGL {
    public unsafe class AdjacentCubeModel : IBufferSource {
        ...
        public IEnumerable<VertexBuffer> GetVertexAttribute(string bufferName) {
            if (strPosition == bufferName) {
                if (this.positionBuffer == null) {
                    this.positionBuffer = this.instancePositions.GenVertexBuffer(VBOConfig.Vec3, GLBuffer.Usage.StaticDraw);
                }
            ...
            //    {
            //        this.uvBuffer = uvs.GenVertexBuffer(VBOConfig.Vec2, GLBuffer.BufferUsage.StaticDraw);
            //    }
            ...
            //}
                ...
                if (this.normalBuffer == null) {
                    this.normalBuffer = this.instanceNormals.GenVertexBuffer(VBOConfig.Vec3, GLBuffer.Usage.StaticDraw);
                }
        ...
        public IEnumerable<IDrawCommand> GetDrawCommand() {
            if (this.command == null) {
                //IndexBuffer indexBuffer = indexes.GenIndexBuffer(IndexBuffer.ElementType.UShort, GLBuffer.BufferUsage.StaticDraw);
                //this.command = new DrawElementsCmd(indexBuffer, DrawMode.Triangles);
                IndexBuffer indexBuffer = adjacentIndexes.GenIndexBuffer(IndexBuffer.ElementType.UShort, GLBuffer.Usage.StaticDraw);
