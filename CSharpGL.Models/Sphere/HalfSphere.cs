...
namespace CSharpGL {
    ...
    /// </summary>
    public unsafe class HalfSphere : IBufferSource {
        private HalfSphereModel model;

        /// <summary>
        /// 一个半球体的模型。半球体的下半部分被挤压到平面上，从而形成了半球体。
        /// </summary>
        /// <param name="radius"></param>
        /// <param name="latitudeParts">用纬线把地球切割为几块。</param>
        /// <param name="longitudeParts">用经线把地球切割为几块。</param>
        public HalfSphere(float radius = 1.0f, int latitudeParts = 10, int longitudeParts = 40) {
            this.model = new HalfSphereModel(radius, latitudeParts, longitudeParts);
        ...
        public IEnumerable<VertexBuffer> GetVertexAttribute(string bufferName) {
            if (bufferName == strPosition) {
                ...
                if (this.uvBuffer == null) {
                    ...
                    // another way to do this:
                    this.uvBuffer = model.uv.GenVertexBuffer(VBOConfig.Vec2, GLBuffer.Usage.StaticDraw);
                }
