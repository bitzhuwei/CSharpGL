        ...
        public IEnumerable<VertexBuffer> GetVertexAttribute(string bufferName) {
            if (strPosition == bufferName) // requiring position buffer.
            {
                if (this.positionBuffer == null) {
                    this.positionBuffer = array.GenVertexBuffer(VBOConfig.Vec3, GLBuffer.Usage.StaticDraw);
                }
            ...
            else if (strColor == bufferName) // requiring position buffer.
            {
                if (this.colorBuffer == null) {
                    this.colorBuffer = array.GenVertexBuffer(VBOConfig.Vec3, GLBuffer.Usage.StaticDraw);
                }
