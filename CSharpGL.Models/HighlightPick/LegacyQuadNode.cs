...
namespace CSharpGL {
    ...
    /// 
    /// </summary>
    public unsafe class LegacyQuadNode : SceneNodeBase, IRenderable {
        /// <summary>
        /// 
        /// </summary>
        ...
        public void RenderBeforeChildren(RenderEventArgs arg) {
            ...
            gl.glColor3f(this.Color3.x, this.Color3.y, this.Color3.z);
            gl.glVertex3f(this.Vertex3.x, this.Vertex3.y, this.Vertex3.z);
            gl.glEnd();
