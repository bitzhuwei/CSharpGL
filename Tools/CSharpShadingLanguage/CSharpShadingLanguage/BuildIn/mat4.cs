...
namespace CSharpShadingLanguage
{
    ...
    public class mat4
    {
        ...
        internal mat4(vec4 a, vec4 b, vec4 c, vec4 d)
        {
            this.col0 = a;
            this.col1 = b;
            this.col2 = c;
        ...
        /// The element at <paramref name="column"/> and <paramref name="row"/>.
        /// </returns>
        internal float this[int column, int row]
        {
            get
            {
