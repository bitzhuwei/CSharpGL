...
namespace CSharpGL.LightEffects
{
    ...
    {
        private DiffuseReflectionPointLightRenderer diffuseReflectionRenderer;

        public FormDiffuseReflectionPointLightController(DiffuseReflectionPointLightRenderer diffuseReflectionRenderer)
        {
            InitializeComponent();
