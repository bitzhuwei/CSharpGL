...
namespace demos.glGuide8code {
    ...
    public unsafe class ch11_OIT : _glGuide8code {
        ~ch11_OIT() {
        ...
        public ch11_OIT(Form mainForm, int width, int height, GL gl)
        ...
        public override void init(CSharpGL.GL gl) {
            {
                var vsCodeFile = "11/ch11_OIT/build_lists.vs.glsl";
                var fsCodeFile = "11/ch11_OIT/build_lists.fs.glsl";
            ...
            {
                var vsCodeFile = "11/ch11_OIT/resolve_lists.vs.glsl";
                var fsCodeFile = "11/ch11_OIT/resolve_lists.fs.glsl";
                var program = Utility.LoadShaders(vsCodeFile, fsCodeFile);
