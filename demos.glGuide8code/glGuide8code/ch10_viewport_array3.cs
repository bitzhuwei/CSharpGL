...
namespace demos.glGuide8code {
    ...
    public unsafe class ch10_viewport_array3 : _glGuide8code {
        ~ch10_viewport_array3() {
        ...
        public ch10_viewport_array3(Form mainForm, int width, int height, GL gl)
        ...
        public override void init(CSharpGL.GL gl) {
            {
                var vsCodeFile = "10/ch10_viewport_array3/render.vert";
                var gsCodeFile = "10/ch10_viewport_array3/render.geom";
                var fsCodeFile = "10/ch10_viewport_array3/render.frag";
