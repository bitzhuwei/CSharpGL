...
namespace demos.glGuide8code {
    ...
    public unsafe class ch12_simplecompute : _glGuide8code {
        ~ch12_simplecompute() {
        ...
        public ch12_simplecompute(Form mainForm, int width, int height, GL gl)
        ...
        public override void init(CSharpGL.GL gl) {
            {
                var vsCodeFile = "12/ch12_simplecompute/simple.comp";
            ...
            {
                var vsCodeFile = "12/ch12_simplecompute/render.vert";
                var fsCodeFile = "12/ch12_simplecompute/render.frag";
            ...
            }
            {
                ...
                gl.glTexStorage2D(GL.GL_TEXTURE_2D, 8, GL.GL_RGBA32F, 256, 256);
        ...
        public override void display(CSharpGL.GL gl) {
            ...
            gl.glBindImageTexture(0, output_image, 0, false, 0, GL.GL_WRITE_ONLY, GL.GL_RGBA32F);
            gl.glDispatchCompute(8, 16, 1);
