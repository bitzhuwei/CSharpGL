...
namespace demos.glGuide8code {
    ...
    public unsafe class ch06_texture_wrapping : _glGuide8code {
        ...
        public ch06_texture_wrapping(Form mainForm, int width, int height, GL gl)
        ...
        public override void init(CSharpGL.GL gl) {
            {
                var vsCodeFile = "06/ch06_texture_wrapping/quad_shader.vs.glsl";
                var fsCodeFile = "06/ch06_texture_wrapping/quad_shader.fs.glsl";
        ...
        int ticks = 0;
        static GLint[] wrap_modes = { (GLint)GL.GL_CLAMP_TO_EDGE, (GLint)GL.GL_CLAMP_TO_BORDER, (GLint)GL.GL_REPEAT, (GLint)GL.GL_MIRRORED_REPEAT };
        public override void display(CSharpGL.GL gl) {
            ...
            gl.glTexParameteri(GL.GL_TEXTURE_2D, GL.GL_TEXTURE_WRAP_S, wrap_modes[(ticks >> 11) & 0x3]);
            gl.glTexParameteri(GL.GL_TEXTURE_2D, GL.GL_TEXTURE_WRAP_T, wrap_modes[(ticks >> 11) & 0x3]);
