...
miniDFA0 -->|"[0-9]"|miniDFA6
miniDFA0 -->|"[-+]"|miniDFA1
miniDFA6 -->|"[Ee]"|miniDFA2
miniDFA6 -->|"[.]"|miniDFA7
miniDFA6 -->|"[0-9]"|miniDFA6
miniDFA1 -->|"[0-9]"|miniDFA6
miniDFA2 -->|"[0-9]"|miniDFA8
miniDFA2 -->|"[-+]"|miniDFA3
miniDFA7 -->|"[Ee]"|miniDFA2
miniDFA7 -->|"[.]"|miniDFA9
miniDFA7 -->|"[0-9]"|miniDFA10
miniDFA8 -->|"[Ee]"|miniDFA4
miniDFA8 -->|"[0-9]"|miniDFA8
miniDFA3 -->|"[0-9]"|miniDFA8
miniDFA9 -->|"[Ee]"|miniDFA2
miniDFA9 -->|"[0-9]"|miniDFA11
miniDFA10 -->|"[Ee]"|miniDFA2
miniDFA10 -->|"[.]"|miniDFA9
miniDFA10 -->|"[0-9]"|miniDFA10
miniDFA4 -->|"[0-9]"|miniDFA12
miniDFA4 -->|"[-+]"|miniDFA5
miniDFA11 -->|"[Ee]"|miniDFA2
miniDFA11 -->|"[0-9]"|miniDFA11
miniDFA12 -->|"[0-9]"|miniDFA12
miniDFA5 -->|"[0-9]"|miniDFA12
```
-------------------------------
# 5/5: miniDFA.simple
```Mermaid
...
eNFA1_18[["εNFA1-18 regex end"]]
eNFA1_7[["εNFA1-7 regex start"]]
eNFA1_11[["εNFA1-11 scope{0, 1}"]]
eNFA1_19[["εNFA1-19 post-regex start"]]
eNFA1_4[["εNFA1-4 scope{1, 1}"]]
eNFA1_12[["εNFA1-12 scope[1]"]]
eNFA1_20[\"εNFA1-20 post-regex end"/]
eNFA1_5[["εNFA1-5 scope[1]"]]
...
subgraph DFA3["DFA3 1 NFA States"]
NFA1_10_3("NFA1-10 scope[1]")
end
subgraph DFA4["DFA4 1 NFA States"]
NFA1_5_4[\"NFA1-5 scope[1]"/]
end
subgraph DFA5["DFA5 1 NFA States"]
NFA1_14_5[\"NFA1-14 scope[1]"/]
end
subgraph DFA6["DFA6 1 NFA States"]
NFA1_12_6("NFA1-12 scope[1]")
end
subgraph DFA7["DFA7 1 NFA States"]
NFA1_5_7[\"NFA1-5 scope[1]"/]
end
subgraph DFA8["DFA8 1 NFA States"]
NFA1_6_8[\"NFA1-6 scope{0, -1}"/]
end
subgraph DFA9["DFA9 1 NFA States"]
NFA1_10_9("NFA1-10 scope[1]")
end
subgraph DFA10["DFA10 1 NFA States"]
NFA1_6_10[\"NFA1-6 scope{0, -1}"/]
end
subgraph DFA11["DFA11 1 NFA States"]
NFA1_14_11[\"NFA1-14 scope[1]"/]
end
subgraph DFA12["DFA12 1 NFA States"]
NFA1_12_12("NFA1-12 scope[1]")
end
DFA0 -->|"[0-9]"|DFA1
DFA0 -->|"[-+]"|DFA2
DFA1 -->|"[Ee]"|DFA3
