...
namespace SoftGLImpl {
    partial class SoftGL {
        private static unsafe ConcurrentBag<FragmentCodeBase[]> LinearInterpolationAndFragmentShaderStage4LineStrip(
            ...
            for (int indexID = indices.ToInt32() / elementBytes, c = 0; c < count - 1 && indexID < indexCount - 1; indexID++, c++) {
