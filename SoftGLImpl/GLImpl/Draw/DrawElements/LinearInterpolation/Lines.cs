...
namespace SoftGLImpl {
    partial class SoftGL {
        private static unsafe ConcurrentBag<FragmentCodeBase[]> LinearInterpolationAndFragmentShaderStage4Lines(
            ...
            for (int indexID = indices.ToInt32() / elementBytes, c = 0; c < count - 1 && indexID < indexCount - 1; indexID += 2, c += 2) {
                ...
                //{
                //    vec3 diff = (fragCoords[0] - fragCoords[1]); // discard line that is too small.
