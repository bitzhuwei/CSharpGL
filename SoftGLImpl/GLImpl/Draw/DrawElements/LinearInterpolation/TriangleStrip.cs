...
namespace SoftGLImpl {
    partial class SoftGL {
        private static unsafe ConcurrentBag<FragmentCodeBase[]> LinearInterpolationAndFragmentShaderStage4TriangleStrip(
            ...
            for (int indexID = indices.ToInt32() / elementBytes, c = 0; c < count - 2 && indexID < indexCount - 2; indexID++, c++) {
