...
namespace SoftGLImpl {
    partial class SoftGL {
        // TODO: GL_POLYGON is a line circle when glPolygonMode(GL_LINE) is enabled;.
        private static unsafe ConcurrentBag<FragmentCodeBase[]> LinearInterpolationAndFragmentShaderStage4TriangleFan(
            ...
            for (uint c = 0; c < count - 2; c++) {
                ...
                var primitive = FindFragmentsInTriangle_V3(//fragCoord0, fragCoord1, fragCoord2,
