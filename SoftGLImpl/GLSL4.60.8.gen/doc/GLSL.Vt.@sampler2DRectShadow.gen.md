# Vt: 'sampler2DRectShadow'

patterns[0]: `sampler2DRectShadow`
...
eNFA0_39[["εNFA0-39 regex end"]]
eNFA0_40[["εNFA0-40 post-regex start"]]
eNFA0_41[\"εNFA0-41 post-regex end"/]
eNFA0_38 -.->|"ε"|eNFA0_0
eNFA0_0 -->|"s"|eNFA0_1
eNFA0_1 -.->|"ε"|eNFA0_2
eNFA0_2 -->|"a"|eNFA0_3
...
miniDFA6 -->|"e"|miniDFA8
miniDFA8 -->|"r"|miniDFA9
miniDFA9 -->|"2"|miniDFA10
miniDFA10 -->|"D"|miniDFA11
miniDFA11 -->|"R"|miniDFA7
miniDFA7 -->|"e"|miniDFA12
miniDFA12 -->|"c"|miniDFA13
miniDFA13 -->|"t"|miniDFA14
miniDFA14 -->|"S"|miniDFA15
miniDFA15 -->|"h"|miniDFA2
miniDFA2 -->|"a"|miniDFA16
miniDFA16 -->|"d"|miniDFA17
miniDFA17 -->|"o"|miniDFA18
miniDFA18 -->|"w"|miniDFA19
```
-------------------------------
# 5/5: miniDFA.simple
```Mermaid
...
eNFA1_39[["εNFA1-39 regex end"]]
eNFA1_40[["εNFA1-40 post-regex start"]]
eNFA1_41[\"εNFA1-41 post-regex end"/]
eNFA1_38 -.->|"ε"|eNFA1_0
eNFA1_0 -->|"s"|eNFA1_1
eNFA1_1 -.->|"ε"|eNFA1_2
eNFA1_2 -->|"a"|eNFA1_3
