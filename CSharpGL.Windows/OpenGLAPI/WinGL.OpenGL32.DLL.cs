...
namespace CSharpGL
{
    public partial class WinGL
    {
        ...
        public static extern void glColorMask(bool redWritable, bool greenWritable, bool blueWritable, bool alphaWritable);
        ...
        public static extern void glDepthMask(bool writable);
        ...
        public static extern void glGetBooleanv(uint pname, byte[] parameters);
        ...
        public static extern void glGetPointerv(uint pname, int[] parameters);
        ...
        public static extern void glMap1d(uint target, double u1, double u2, int stride, int order, IntPtr points);
        ...
        public static extern void glMap1f(uint target, float u1, float u2, int stride, int order, IntPtr points);
        ...
        public static extern void glMap2d(uint target, double u1, double u2, int ustride, int uorder, double v1, double v2, int vstride, int vorder, IntPtr points);
        ...
        public static extern void glMap2f(uint target, float u1, float u2, int ustride, int uorder, float v1, float v2, int vstride, int vorder, IntPtr points);
