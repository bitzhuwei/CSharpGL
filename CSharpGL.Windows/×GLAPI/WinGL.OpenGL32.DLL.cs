...
namespace CSharpGL {
    public unsafe partial class WinGL {
        ...
        private static extern delegate* unmanaged<uint, float, void> glAccum();

        private delegate*<uint, float, void> xxxx;
        void xxx() {
            var func = glAccum();
            func(1, 2.0f);

            if (xxxx == null) { xxxx = (delegate*<uint, float, void>)GetProc("glAccum"); }
            xxxx(1, 2.0f);
        }
        void xxx2() {
            IntPtr ptr = IntPtr.Zero;
            var func = (delegate* unmanaged<uint, float, void>)ptr;
            func(1, 2.0f);
        }
