...
namespace c08d03_flat {
    internal unsafe class c08d03_flat_ : demoCode {
        public c08d03_flat_(FormInstance mainForm, WindowsGLCanvas canvas) : base(mainForm, canvas) { }
        private Scene scene;
        ...
        private void Canvas_GLMouseMove(object sender, GLMouseEventArgs e) {
            ...
            var builder = new StringBuilder();
            {
                ...
                // get coded color.
                //GL.Current.ReadPixels(x, y, 1, 1, GL.GL_RGBA, GL.GL_UNSIGNED_BYTE, header);
                //pinned.Free();
