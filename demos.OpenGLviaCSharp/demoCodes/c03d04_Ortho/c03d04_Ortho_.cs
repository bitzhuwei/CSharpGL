...
namespace c03d04_Ortho {
    internal unsafe class c03d04_Ortho_ : demoCode {
        public c03d04_Ortho_(FormInstance mainForm, WindowsGLCanvas canvas) : base(mainForm, canvas) { }
        private Scene scene;
        ...
        private SceneNodeBase GetRootNode() {
            ...
            {
                var perspectiveNode = OrthoNode.Create();
