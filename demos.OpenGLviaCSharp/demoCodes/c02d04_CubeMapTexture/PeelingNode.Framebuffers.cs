    ...
    class PeelingResource {
        ...
        public PeelingResource(int width, int height) {
            ...
            for (int i = 0; i < 2; i++) {
                ...
                framebuffer.Attach(Framebuffer.Target.Framebuffer, depthTexture, AttachmentLocation.Depth);
                framebuffer.Attach(Framebuffer.Target.Framebuffer, colorTexture, 0u);
...

            {
                ...
                framebuffer.Attach(Framebuffer.Target.Framebuffer, this.depthTextures[0], AttachmentLocation.Depth);
                framebuffer.Attach(Framebuffer.Target.Framebuffer, colorTexture, 0u);
