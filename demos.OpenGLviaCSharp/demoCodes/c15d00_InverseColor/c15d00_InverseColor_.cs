...
namespace c15d00_InverseColor {
    internal unsafe class c15d00_InverseColor_ : demoCode {
        public c15d00_InverseColor_(FormInstance mainForm, WindowsGLCanvas canvas) : base(mainForm, canvas) { }
        private Scene scene;
        ...
        public override void init(GL gl) {
            ...
            this.scene = new Scene(camera);
            {
                ...
                string filename = "media/textures/earth.png";
            ...
            MessageBox.Show("N: switch config!");
