    ...
    class StaticSlicesModel : IBufferSource {
        ...
        public IEnumerable<VertexBuffer> GetVertexAttribute(string bufferName) {
            if (strPosition == bufferName) {
                ...
                if (this.texCoordBuffer == null) {
                    this.texCoordBuffer = this.texCoords.GenVertexBuffer(VBOConfig.Vec3, GLBuffer.Usage.StaticDraw);
                }
        ...
        public IEnumerable<IDrawCommand> GetDrawCommand() {
            if (this.drawCommand == null) {
                this.drawCommand = new DrawArraysCmd(CSharpGL.DrawMode.Quads, this.positions.Length);
            }
