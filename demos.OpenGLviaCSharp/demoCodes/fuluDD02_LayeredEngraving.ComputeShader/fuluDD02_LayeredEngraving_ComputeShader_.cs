...
namespace fuluDD02_LayeredEngraving.ComputeShader {
    internal unsafe class fuluDD02_LayeredEngraving_ComputeShader_ : demoCode {
        public fuluDD02_LayeredEngraving_ComputeShader_(FormInstance mainForm, WindowsGLCanvas canvas) : base(mainForm, canvas) { }
        private Scene scene;
