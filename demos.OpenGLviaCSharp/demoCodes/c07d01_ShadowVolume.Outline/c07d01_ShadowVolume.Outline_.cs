...
namespace c07d01_ShadowVolume.Outline {
    internal unsafe class c07d01_ShadowVolume_Outline_ : demoCode {
        public c07d01_ShadowVolume_Outline_(FormInstance mainForm, WindowsGLCanvas canvas) : base(mainForm, canvas) { }
        private Scene scene;
        ...
        public override void init(GL gl) {
            ...
            (new FormNodePropertyGrid(this.scene.RootNode)).Show();
