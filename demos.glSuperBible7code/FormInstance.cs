...
namespace demos.glSuperBible7code {
    public unsafe partial class FormInstance : Form {
        ...
        private _glSuperBible7code? currentInstance;
        ...
        private void FormInstance_Load(object? sender, EventArgs e) {
            ...
            var instance = Activator.CreateInstance(instanceType,
                this, this.glCanvas1.Width, this.glCanvas1.Height, gl) as _glSuperBible7code;
        ...
        private void UpdateText() {
            this.Text = $"openGL Program Guide 8th Edition - FPS: {this.glCanvas1.GetFPS().ToString("000.00")}";
        }
