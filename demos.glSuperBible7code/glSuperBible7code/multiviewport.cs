...
namespace demos.glSuperBible7code {
    ...
    public unsafe class multiviewport : _glSuperBible7code {
        ~multiviewport() {
        ...
        public multiviewport(Form mainForm, int width, int height, GL gl)
        ...
        public override void init(CSharpGL.GL gl) {
            {
                var vsCodeFile = "media/shaders/multiviewport.vert";
                var gsCodeFile = "media/shaders/multiviewport.geom";
                var fsCodeFile = "media/shaders/multiviewport.frag";
        ...
        public override void display(CSharpGL.GL gl) {
            ...
            float viewport_width = (float)(7 * this.width) / 16.0f;
            float viewport_height = (float)(7 * this.height) / 16.0f;

            // Four rectangles - lower left first...
            gl.glViewportIndexedf(0, 0, 0, viewport_width, viewport_height);

            // Lower right...
            gl.glViewportIndexedf(1,
                this.width - viewport_width, 0,
                viewport_width, viewport_height);

            // Upper left...
            gl.glViewportIndexedf(2,
                0, this.height - viewport_height,
                viewport_width, viewport_height);

            // Upper right...
            gl.glViewportIndexedf(3,
