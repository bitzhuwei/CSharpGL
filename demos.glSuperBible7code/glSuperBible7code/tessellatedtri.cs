...
namespace demos.glSuperBible7code {
    ...
    public unsafe class tessellatedtri : _glSuperBible7code {
        ~tessellatedtri() {
        ...
        public tessellatedtri(Form mainForm, int width, int height, GL gl)
            : base(mainForm, width, height, gl) { }

        GLuint program;
        GLuint vao;

        bool polygonLine = true;

        public override void init(CSharpGL.GL gl) {
            {
                var vsCodeFile = "media/shaders/tessellatedtri.vert";
                var tcCodeFile = "media/shaders/tessellatedtri.tesc";
                var teCodeFile = "media/shaders/tessellatedtri.tese";
                var fsCodeFile = "media/shaders/tessellatedtri.frag";
        ...
        public override Keys[] ValidKeys => [Keys.P];
