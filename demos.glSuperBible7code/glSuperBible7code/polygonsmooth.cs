...
namespace demos.glSuperBible7code {
    ...
    public unsafe class polygonsmooth : _glSuperBible7code {
        ~polygonsmooth() {
        ...
        public polygonsmooth(Form mainForm, int width, int height, GL gl)
        ...
        public override void init(CSharpGL.GL gl) {
            {
                var vsCodeFile = "media/shaders/polygonsmooth.vert";
                var fsCodeFile = "media/shaders/polygonsmooth.frag";
