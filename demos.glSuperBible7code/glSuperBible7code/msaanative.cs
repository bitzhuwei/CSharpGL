...
namespace demos.glSuperBible7code {
    ...
    public unsafe class msaanative : _glSuperBible7code {
        ~msaanative() {
        ...
        public msaanative(Form mainForm, int width, int height, GL gl)
        ...
        public override void init(CSharpGL.GL gl) {
            {
                var vsCodeFile = "media/shaders/msaanative.vert";
                var fsCodeFile = "media/shaders/msaanative.frag";
