...
namespace demos.glSuperBible7code {
    ...
    public unsafe class singlepoint : _glSuperBible7code {
        ~singlepoint() {
        ...
        public singlepoint(Form mainForm, int width, int height, GL gl)
        ...
        public override void init(CSharpGL.GL gl) {
            {
                var vsCodeFile = "media/shaders/singlepoint.vert";
                var fsCodeFile = "media/shaders/singlepoint.frag";
