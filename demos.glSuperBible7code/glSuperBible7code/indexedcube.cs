...
namespace demos.glSuperBible7code {
    ...
    public unsafe class indexedcube : _glSuperBible7code {
        ~indexedcube() {
        ...
        public indexedcube(Form mainForm, int width, int height, GL gl)
        ...
        public override void init(CSharpGL.GL gl) {
            {
                var vsCodeFile = "media/shaders/indexedcube.vert";
                var fsCodeFile = "media/shaders/indexedcube.frag";
