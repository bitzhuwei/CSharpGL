...
namespace demos.glSuperBible7code {
    ...
    public unsafe class normalviewer : _glSuperBible7code {
        ~normalviewer() {
        ...
        public normalviewer(Form mainForm, int width, int height, GL gl)
        ...
        public override void init(CSharpGL.GL gl) {
            {
                var vsCodeFile = "media/shaders/normalviewer.vert";
                var gsCodeFile = "media/shaders/normalviewer.geom";
                var fsCodeFile = "media/shaders/normalviewer.frag";
                ...
                normal_length_location = gl.glGetUniformLocation(program, "normal_length");
        ...
        public override void display(CSharpGL.GL gl) {
            ...
            mat4 mv_matrix = glm.translate(0.0f, 0.0f, -3.0f) *
                glm.rotate((float)currentTime * 15.0f, 0.0f, 1.0f, 0.0f) *
                glm.rotate((float)currentTime * 21.0f, 1.0f, 0.0f, 0.0f);
            gl.glUniformMatrix4fv(mv_location, 1, false, (float*)&mv_matrix);

            gl.glUniform1f(normal_length_location, (float)Math.Sin((float)currentTime * 8.0f) * (float)Math.Cos((float)currentTime * 6.0f) * 0.03f + 0.05f);
