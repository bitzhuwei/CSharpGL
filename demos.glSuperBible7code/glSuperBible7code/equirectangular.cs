...
namespace demos.glSuperBible7code {
    ...
    public unsafe class equirectangular : _glSuperBible7code {
        ~equirectangular() {
        ...
        public equirectangular(Form mainForm, int width, int height, GL gl)
            : base(mainForm, width, height, gl) { }

        GLuint render_prog;

        GLuint tex_envmap;
        GLuint[] envmaps = new uint[3];
        int envmap_index;
        ...
        public override void init(CSharpGL.GL gl) {
            {
                var vsCodeFile = "media/shaders/equirectangular.vert";
                var fsCodeFile = "media/shaders/equirectangular.frag";
            ...
            {
                envmaps[0] = sb7ktx.load("media/textures/equirectangularmap1.ktx");
        ...
        public override Keys[] ValidKeys => [Keys.E];
