...
namespace demos.glSuperBible7code {
    ...
    public unsafe class movingtri : _glSuperBible7code {
        ~movingtri() {
        ...
        public movingtri(Form mainForm, int width, int height, GL gl)
        ...
        public override void init(CSharpGL.GL gl) {
            {
                var vsCodeFile = "media/shaders/movingtri.vert";
                var fsCodeFile = "media/shaders/movingtri.frag";
        ...
        public override void display(CSharpGL.GL gl) {
            ...
            var attrib = stackalloc GLfloat[] {
                (float)Math.Sin(currentTime) * 0.5f,
                (float)(float)Math.Cos(currentTime) * 0.6f,
                0.0f,
                0.0f
            };
