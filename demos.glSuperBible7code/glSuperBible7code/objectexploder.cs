...
namespace demos.glSuperBible7code {
    ...
    public unsafe class objectexploder : _glSuperBible7code {
        ~objectexploder() {
        ...
        public objectexploder(Form mainForm, int width, int height, GL gl)
        ...
        public override void init(CSharpGL.GL gl) {
            {
                var vsCodeFile = "media/shaders/objectexploder.vert";
                var gsCodeFile = "media/shaders/objectexploder.geom";
                var fsCodeFile = "media/shaders/objectexploder.frag";
        ...
        public override void display(CSharpGL.GL gl) {
            ...
            gl.glUniform1f(explode_factor_location, (float)Math.Sin((float)currentTime * 8.0f) * (float)Math.Cos((float)currentTime * 6.0f) * 0.7f + 0.1f);
