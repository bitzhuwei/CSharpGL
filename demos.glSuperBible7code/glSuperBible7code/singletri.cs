...
namespace demos.glSuperBible7code {
    ...
    public unsafe class singletri : _glSuperBible7code {
        ~singletri() {
        ...
        public singletri(Form mainForm, int width, int height, GL gl)
        ...
        public override void init(CSharpGL.GL gl) {
            {
                var vsCodeFile = "media/shaders/singletri.vert";
                var fsCodeFile = "media/shaders/singletri.frag";
