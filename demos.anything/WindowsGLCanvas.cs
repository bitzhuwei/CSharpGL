...
namespace demos.anything {
    public unsafe partial class WindowsGLCanvas : UserControl, IGLCanvas {
        ...
        private static readonly ContextGenerationParams parameters = new ContextGenerationParams() { accumBits = 8 };
...
2025/5/18 10:49:43.705 OnCreateControl: true
        ...
        protected override void OnKeyPress(KeyPressEventArgs e) {
            base.OnKeyPress(e);
            var keyPress = this.GLKeyPress;
            if (keyPress != null) { keyPress(this, new GLKeyPressEventArgs(e.KeyChar)); }
        }
        protected override void OnMouseDown(MouseEventArgs e) {
            base.OnMouseDown(e);
            var mouseDown = this.GLMouseDown;
            if (mouseDown != null) {
                mouseDown(this, new GLMouseEventArgs((GLMouseButtons)e.Button, e.Clicks, e.X, e.Y, e.Delta));
            }
        }
        protected override void OnMouseMove(MouseEventArgs e) {
            base.OnMouseMove(e);
            var mouseMove = this.GLMouseMove;
            if (mouseMove != null) {
                mouseMove(this, new GLMouseEventArgs((GLMouseButtons)e.Button, e.Clicks, e.X, e.Y, e.Delta));
            }
        }
        protected override void OnMouseUp(MouseEventArgs e) {
            base.OnMouseUp(e);
            var mouseUp = this.GLMouseUp;
            if (mouseUp != null) {
                mouseUp(this, new GLMouseEventArgs((GLMouseButtons)e.Button, e.Clicks, e.X, e.Y, e.Delta));
            }
        }
        protected override void OnMouseWheel(MouseEventArgs e) {
            base.OnMouseWheel(e);
            var mouseWheel = this.GLMouseWheel;
            if (mouseWheel != null) {
                mouseWheel(this, new GLMouseEventArgs((GLMouseButtons)e.Button, e.Clicks, e.X, e.Y, e.Delta));
            }
        }
        protected override void OnKeyDown(KeyEventArgs e) {
            base.OnKeyDown(e);
            var keyDown = this.GLKeyDown;
            if (keyDown != null) { keyDown(this, new GLKeyEventArgs((GLKeys)e.KeyData)); }
        }
        protected override void OnKeyUp(KeyEventArgs e) {
            base.OnKeyUp(e);
            var keyUp = this.GLKeyUp;
            if (keyUp != null) { keyUp(this, new GLKeyEventArgs((GLKeys)e.KeyData)); }
        }
    }
}
