        ...
        public IEnumerable<VertexBuffer> GetVertexAttribute(string bufferName) {
            if (bufferName == EZMTextureModel.strPosition) {
                if (this.positionBuffer == null) {
                    this.positionBuffer = this.ezmMesh.Vertexbuffer.GetBuffer(bufferName).array.GenVertexBuffer(VBOConfig.Vec3, GLBuffer.Usage.StaticDraw);
                }
                ...
                if (this.normalBuffer == null) {
                    this.normalBuffer = this.ezmMesh.Vertexbuffer.GetBuffer(bufferName).array.GenVertexBuffer(VBOConfig.Vec3, GLBuffer.Usage.StaticDraw);
                }
                ...
                if (this.uvBuffer == null) {
                    this.uvBuffer = this.ezmMesh.Vertexbuffer.GetBuffer(bufferName).array.GenVertexBuffer(VBOConfig.Vec2, GLBuffer.Usage.StaticDraw);
                }
                ...
                if (this.blendWeightsBuffer == null) {
                    this.blendWeightsBuffer = this.ezmMesh.Vertexbuffer.GetBuffer(bufferName).array.GenVertexBuffer(VBOConfig.Vec4, GLBuffer.Usage.StaticDraw);
                }
                ...
                if (this.blendIndicesBuffer == null) {
                    this.blendIndicesBuffer = this.ezmMesh.Vertexbuffer.GetBuffer(bufferName).array.GenVertexBuffer(VBOConfig.IVec4, GLBuffer.Usage.StaticDraw);
                }
