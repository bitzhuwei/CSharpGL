    ...
    partial class JointNode {
        ...
        private static void ReadNodeHeirarchy(float animationTime, Assimp.Node node, Assimp.Animation animation, mat4 parentTransform, AllBoneInfos allBones) {
            ...
            if (nodeAnim != null) {
                ...
                mat4 ScalingM = glm.scale(new vec3(Scaling.X, Scaling.Y, Scaling.Z));
                ...
                mat4 TranslationM = glm.translate(new vec3(Translation.X, Translation.Y, Translation.Z));
            ...
            if (allBones.name2index.ContainsKey(nodeName)) {
                uint BoneIndex = allBones.name2index[nodeName];
