    ...
    public static class BoneMatrixHelper {
        ...
        private static void ReadNodeHeirarchy(float animationTime, Assimp.Node node, Assimp.Animation animation, mat4 parentTransform, AllBoneInfos allBoneInfos) {
            ...
            if (nodeAnim != null) {
                ...
                mat4 scalingMat = glm.scale(new vec3(scaling.X, scaling.Y, scaling.Z));
                ...
                mat4 translationMat = glm.translate(new vec3(translation.X, translation.Y, translation.Z));
            ...
            if (allBoneInfos.name2index.ContainsKey(nodeName)) {
                uint BoneIndex = allBoneInfos.name2index[nodeName];
