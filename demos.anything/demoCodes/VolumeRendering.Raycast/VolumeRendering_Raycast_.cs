...
namespace VolumeRendering.Raycast {
    internal unsafe class VolumeRendering_Raycast_ : demoCode {
        public VolumeRendering_Raycast_(FormInstance mainForm, WindowsGLCanvas canvas) : base(mainForm, canvas) { }
        private Scene scene;
