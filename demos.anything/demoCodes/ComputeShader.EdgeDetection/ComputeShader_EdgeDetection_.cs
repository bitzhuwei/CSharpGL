...
namespace ComputeShader.EdgeDetection {
    internal unsafe class ComputeShader_EdgeDetection_ : demoCode {
        public ComputeShader_EdgeDetection_(FormInstance mainForm, WindowsGLCanvas canvas) : base(mainForm, canvas) { }
        private Scene scene;
