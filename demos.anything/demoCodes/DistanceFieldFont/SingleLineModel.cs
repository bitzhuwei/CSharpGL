    ...
    public partial class SingleLineModel : IBufferSource {
        ...
        public IEnumerable<VertexBuffer> GetVertexAttribute(string bufferName) {
            if (bufferName == strPosition) {
                if (this.positionBuffer == null) {
                    this.positionBuffer = VertexBuffer.Create(typeof(GlyphPosition), this.Capacity, VBOConfig.Vec2, GLBuffer.Usage.DynamicDraw);
                }
                ...
                if (this.texCoordBuffer == null) {
                    this.texCoordBuffer = VertexBuffer.Create(typeof(GlyphTexCoord), this.Capacity, VBOConfig.Vec2, GLBuffer.Usage.DynamicDraw);
                }
        ...
        public IEnumerable<IDrawCommand> GetDrawCommand() {
            if (this.drawCmd == null) {
                var drawCmd = new DrawArraysCmd(CSharpGL.DrawMode.Quads, this.Capacity * 4);
