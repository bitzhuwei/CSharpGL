    ...
    class ParticleModel : IBufferSource {
        ...
        public IEnumerable<IDrawCommand> GetDrawCommand() {
            if (this.drawCmd == null) {
                IndexBuffer buffer = this.indices.GenIndexBuffer(IndexBuffer.ElementType.UInt, GLBuffer.Usage.StaticDraw);
                this.drawCmd = new DrawElementsCmd(buffer, CSharpGL.DrawMode.TriangleStrip, uint.MaxValue);
            }
