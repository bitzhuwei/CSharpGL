...
namespace DepthPeeling.DualPeeling {
    internal unsafe class DepthPeeling_DualPeeling_ : demoCode {
        public DepthPeeling_DualPeeling_(FormInstance mainForm, WindowsGLCanvas canvas) : base(mainForm, canvas) { }
        private Scene scene;
