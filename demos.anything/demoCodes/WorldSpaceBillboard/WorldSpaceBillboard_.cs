...
namespace WorldSpaceBillboard {
    internal unsafe class WorldSpaceBillboard_ : demoCode {
        public WorldSpaceBillboard_(FormInstance mainForm, WindowsGLCanvas canvas) : base(mainForm, canvas) { }
        private Scene scene;
        ...
        public override void init(GL gl) {
            ...
            (new FormObjPropertyGrid(billboardSortAction)).Show();
        ...
        private void Canvas_GLKeyDown(object sender, GLKeyEventArgs e) {
            if (e.KeyData == GLKeys.B) {
                ...
                this.mainForm.SetInfo(string.Format("s:{0}, d:{1}", s, d));
            }
        }
