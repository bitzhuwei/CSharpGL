...
namespace CSharpGL.Objects.Common
{
    ...
    /// <summary>
    /// 一个<see cref="GroundRenderer"/>对应一个(vertex shader+fragment shader+..shader)组成的shader program。
    /// </summary>
    public class GroundRenderer : RendererBase
    {
        ...
        const string strlineColor = "lineColor";
        ...
        public GroundRenderer(Ground model)
        {
            this.model = model;
        }
        ...
        {
            var vertexShaderSource = ManifestResourceLoader.LoadTextFile("Ground.vert");
            var fragmentShaderSource = ManifestResourceLoader.LoadTextFile("Ground.frag");
        ...
        protected void InitializeVAO()
        {
            ...
            this.lineColor = this.model.lineColor;
        ...
        protected override void DoRender(RenderEventArgs e)
        {
            ...
            program.SetUniform(strlineColor, lineColor.x, lineColor.y, lineColor.z);
