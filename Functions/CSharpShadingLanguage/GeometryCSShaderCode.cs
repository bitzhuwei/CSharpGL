...
namespace CSharpShadingLanguage
{
    ...
    public abstract class GeometryCSShaderCode : CSShaderCode
    {
        ...
        {
            public gl_inElement this[int index] { get { throw new NotNeedToImplementException(); } }

            public int length() { throw new NotNeedToImplementException(); }
        }
        ...
        protected void EmitVertex() { throw new NotNeedToImplementException(); }
        protected void EndPrimitive() { throw new NotNeedToImplementException(); }
    }
