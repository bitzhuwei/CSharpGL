...
namespace CSharpGL.Objects.Demos.VolumeRendering
{
    ...
    /// 用多个六面体进行VR渲染。
    /// </summary>
    public class DemoVolumeRendering03 : SceneElementBase, IMVP
    {
        ...
        {
            var vertexShaderSource = ManifestResourceLoader.LoadTextFile(@"VolumeRendering.DemoVolumeRendering03.vert");
            var fragmentShaderSource = ManifestResourceLoader.LoadTextFile(@"VolumeRendering.DemoVolumeRendering03.frag");
