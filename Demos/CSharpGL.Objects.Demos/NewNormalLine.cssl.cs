...
namespace CSharpGL.Objects.Demos
{
    ...
    /// </summary>
    [Dump2File(true)]
    class NewNormalLineVert : VertexCSShaderCode
    {
        /// <summary>
        /// vertex's position.
        /// </summar>
    ...
    /// </summary>
    [Dump2File(true)]
    class NewNormalLineFrag : FragmentCSShaderCode
    {
        /// <summary>
    ...
    [Dump2File(true)]
    class NewNormalLineGeom : GeometryCSShaderCode
    {
        ...
        [Uniform]
        float showModel = 1.0f;

        [Uniform]
        float showNormal = 1.0f;
