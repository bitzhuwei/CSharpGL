...
namespace CSharpGL.Objects.Demos
{
    ...
    /// <summary>
    /// 一个<see cref="SimpleRenderer"/>对应一个(vertex shader+fragment shader+..shader)组成的shader program。
    /// </summary>
    public class SimpleRenderer : RendererBase
    {
        ...
        public SimpleRenderer(IModel model)
        {
            this.model = model;
        }
        ...
        {
            var vertexShaderSource = ManifestResourceLoader.LoadTextFile("Simple.vert");
            var fragmentShaderSource = ManifestResourceLoader.LoadTextFile("Simple.frag");
