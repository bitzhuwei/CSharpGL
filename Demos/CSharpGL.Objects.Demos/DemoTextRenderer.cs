...
namespace CSharpGL.Objects.Demos
{
    ...
    /// <summary>
    /// 一个<see cref="DemoTextRenderer"/>对应一个(vertex shader+fragment shader+..shader)组成的shader program。
    /// </summary>
    public class DemoTextRenderer : RendererBase
    {
        ...
        public DemoTextRenderer(IModel model)
        {
            this.model = model;
        }
