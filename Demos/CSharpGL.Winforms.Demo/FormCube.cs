...
namespace CSharpGL.Winforms.Demo
{
    ...
    public partial class FormCube : Form
    {
        ...
        void cubeElement_AfterRendering(object sender, Objects.RenderEventArgs e)
        {
            ...
            this.cubeElement.ResetShaderProgram();
        }
        ...
        void cubeElement_BeforeRendering(object sender, Objects.RenderEventArgs e)
        {
            ...
            this.cubeElement.SetMatrix(projectionMatrix, viewMatrix, modelMatrix);
        ...
        private void glCanvas1_KeyPress_1(object sender, KeyPressEventArgs e)
        {
            if(e.KeyChar=='j')
            {
                this.cubeElement.DecreaseVertexCount();
            }
            else if(e.KeyChar=='k')
            {
                this.cubeElement.IncreaseVertexCount();
            }
        }
    }
}
