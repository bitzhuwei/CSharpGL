...
namespace ShadowMapping
{
    ...
    /// </summary>
    public class SMRectangleRenderer : PickableRenderer
    {
...
";
        ...
        /// </summary>
        /// <returns></returns>
        public static SMRectangleRenderer Create()
        {
            ...
            var renderer = new SMRectangleRenderer(new RectangleModel(), provider, map, inPosition);
            renderer.Initialize();
        ...
        /// </summary>
        private SMRectangleRenderer(RectangleModel model, IShaderProgramProvider renderProgramProvider,
