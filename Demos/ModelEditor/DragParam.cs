...
namespace ModelEditor
{
    internal class DragParam
    {
        ...
        public DragParam(vec3 lastModelPos, mat4 projectionMat, mat4 viewMatrix, vec4 viewport, ivec2 lastMousePositionOnScreen)
        {
        ...
        public DragParam(vec3 lastModelPos, mat4 projectionMat, mat4 viewMatrix, vec4 viewport, ivec2 lastMousePositionOnScreen,
           IEnumerable<uint> indexes)
            : this(lastModelPos, projectionMat, viewMatrix, viewport, lastMousePositionOnScreen)
        {
