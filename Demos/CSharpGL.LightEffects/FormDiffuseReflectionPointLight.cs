...
{
    public partial class FormDiffuseReflectionPointLight : Form
    {
        SimpleUIAxis uiAxis;
        DiffuseReflectionPointLightRenderer renderer;
        ...
        public FormDiffuseReflectionPointLight()
        {
            InitializeComponent();
            ...
            this.renderer = new DiffuseReflectionPointLightRenderer(model);
        ...
        {
            var element = new DiffuseReflectionPointLightRenderer(factories[currentModelIndex].Create(this.radius));
            element.Initialize();
        ...
        private FormDiffuseReflectionPointLightDisplay frmDisplay;
        ...
        private void FormGLCanvas_Load(object sender, EventArgs e)
        {
            ...
            this.frmController = new FormDiffuseReflectionPointLightController(this.renderer);
            frmController.Show();
            this.frmDisplay = new FormDiffuseReflectionPointLightDisplay(this.renderer);
