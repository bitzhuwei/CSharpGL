...
{
    public partial class FormPhongPointLight : Form
    {
        SimpleUIAxis uiAxis;
        PhongPointLightRenderer renderer;
        ...
        {
            var element = new PhongPointLightRenderer(factories[currentModelIndex].Create(this.radius));
            element.Initialize();
        ...
        PhongPointLightRenderer newRenderer;
        private FormPhongPointLightController frmController;
        private FormPhongPointLightDisplay frmDisplay;
