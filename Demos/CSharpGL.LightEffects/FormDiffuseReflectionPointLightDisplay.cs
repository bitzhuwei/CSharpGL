...
{
    public partial class FormDiffuseReflectionPointLightDisplay : Form
    {
        private DiffuseReflectionPointLightRenderer renderer;
        public FormDiffuseReflectionPointLightDisplay(DiffuseReflectionPointLightRenderer renderer)
        {
            InitializeComponent();
