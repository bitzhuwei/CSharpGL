...
namespace ArmadaTank
{
    ...
    internal class GroundRenderer : Renderer
    {
        public static GroundRenderer Create(GroundModel model)
        {
            ...
            shaderCodes[0] = new ShaderCode(File.ReadAllText(@"shaders\GroundRenderer\Ground.vert"), ShaderType.VertexShader);
            shaderCodes[1] = new ShaderCode(File.ReadAllText(@"shaders\GroundRenderer\Ground.frag"), ShaderType.FragmentShader);
