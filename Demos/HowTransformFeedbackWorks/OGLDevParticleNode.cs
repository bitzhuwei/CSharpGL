...
{
    partial class OGLDevParticleNode : ModernNode, IRenderable
    {
        ...
        public static OGLDevParticleNode Create(int particleCount)
        {
            ...
            var blend = new BlendSwitch(BlendingSourceFactor.One, BlendingDestinationFactor.One);
            {
        ...
        public void RenderBeforeChildren(RenderEventArgs arg)
        {
            ...
            // update
            {
                ...
                method.Render(IndexAccessMode.ByFrame, tf); // update buffers and record output to tf's binding.
