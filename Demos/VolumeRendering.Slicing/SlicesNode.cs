    ...
    partial class SlicesNode : ModernNode, IRenderable
    {
        ...
        public static SlicesNode Create()
        {
            ...
            }
            {
                ...
                var map = new AttributeMap();
                map.Add("vVertex", SlicesModel.position);
                classificationBuilder = new RenderMethodBuilder(provider, map, new BlendSwitch(BlendingSourceFactor.SourceAlpha, BlendingDestinationFactor.OneMinusSourceAlpha));
            }
