...
namespace CSharpGL
{
    ...
    /// 
    /// </summary>
    public class CubemapViewerModel : IBufferSource
    {
        public vec3 ModelSize { get; private set; }

        public CubemapViewerModel()
        {
        ...
        private const float xLength = 1f;
        private const float yLength = 1f;
        private const float zLength = 1f;
        /// <summary>
        /// four vertexes.
        /// </summary>
